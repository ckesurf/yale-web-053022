...
3. Configure forms to work with HTTP verbs other than GET and POST
4. Use nested params to isolate params coming from form fields
5. Render a delete button
